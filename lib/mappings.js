...
class Mapping {
    constructor(config) {
        ...
        const sectorProperties = {
            mostFrequentMarket: type_keyword
        };

        const datesProperties = {
            awardDecisionYearsMinMax: type_keyword
        };
            ...
            mapping: {
                buyer: {
                    properties: {
                        ...
                        tenders: {
                            type: 'nested',
                            properties: tenderProperties.properties
                        },
                        contractsCount: type_long
                    }
                }
            }
        };
