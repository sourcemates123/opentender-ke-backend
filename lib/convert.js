...
opentender-ke
3.129.99.217:3000 (frontend)
3.129.99.217:3001 (backend)

opentender-ug
3.21.182.68:3000 (frontend)
3.21.182.68:3001 (backend)

opentender-jm
3.13.42.33:3000 (frontend)
3.13.42.33:3001 (backend)
...
class Converter {
	...
	cleanIndicators(rawList) {
		...
		let list = rawList.filter((indicator) => {
			return ! wrongIndicators.includes(indicator.type)
		})
		if (list) {
			list.forEach(doc => {
